...
def index():
    ...
    # Summary
    summary = """Passionate software engineer with a strong experience (>5 years) in SQL and spark query optimization, machine learning, generative AI, 
    ...
    projects = [
        {
            'name': 'NxTreasury',
            'role': 'Technical Advisor (CTO as a service)',
